...
add_filter('wpjam_basic_setting', function(){
	$post_type_options	= wp_list_pluck(get_post_types(['show_ui' => true], 'objects'), 'label', 'name');
	...
	$sections	= [
		'related-posts'	=> [
			...
			'fields'	=>[
				...
				'related_posts_post_types'	=> ['title'=>'文章类型',	'type'=>'checkbox',	'options'=>$post_type_options,	'description'=>'相关文章包含哪些文章类型的文章，默认则为当前文章的类型。'],
