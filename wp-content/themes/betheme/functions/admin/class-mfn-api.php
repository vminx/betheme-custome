...
class Mfn_API {
	...
	protected $url = array(
		...
		'theme_download'	=> 'http://dl.fuych.net/betheme/theme/download.php',
			
		'plugins_version'	=> 'http://api.muffingroup.com/plugins/version.php',
		'plugins_download'	=> 'http://dl.fuych.net/betheme/plugins/download.php',
			
		'websites_download'	=> 'http://dl.fuych.net/betheme/websites/download.php',
